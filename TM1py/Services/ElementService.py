...
class ElementService(ObjectService):
    ...
    def update_edges(self, dimension_name: str, hierarchy_name: str, edges: Iterable[Tuple[str, str]] = None, skip_invalid_edges: bool = False, **kwargs):
        ...
        if skip_invalid_edges: 
            ...
            edges = {key: value for key, value in edges.items() if key[0] in element_list and key[1] in element_list}

        return self.add_edges(dimension_name=dimension_name, hierarchy_name=hierarchy_name, edges=edges)
